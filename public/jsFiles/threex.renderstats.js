...
THREEx.RendererStats	= function (){
    ...
    msText.style.cssText = 'color:#9cb2b2;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px';
    ...
    for(var i = 0; i < nLines; i++){
        ...
        msTexts[i].style.cssText = 'color:#9cb2b2;background-color:#311;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px';
